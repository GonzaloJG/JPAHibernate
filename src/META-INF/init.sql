INSERT INTO customers(birthday, fistname, lastname, reg_date, status) VALUES (curdate(), 'Oscar', 'Blancarte', now(), 'ACTIVE');
INSERT INTO customers(birthday, fistname, lastname, reg_date, status) VALUES (curdate(), 'Juan', 'Perez', now(), 'ACTIVE');
...
INSERT INTO orders (reg_date, status, total, fk_customer) VALUES (now(), 'INACTIVE', 3850, 2);
INSERT INTO orders (reg_date, status, total, fk_customer) VALUES (now(), 'ACTIVE', 0, 3);
...
INSERT INTO order_lines (fk_product, quantity, total, unit_price, fk_order, ctr) VALUES (9,10,100,100,1,8);
